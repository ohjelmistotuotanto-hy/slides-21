...
- Olemassa useita kirjastoja mock-olioiden luomisen helpottamiseksi, laskareissa _mock_ (Python) _Mockito_ (Java)
...
- Robot-frameworkia käytettäessä jokaisesta storystä kirjoitetaan _.robot-_ päätteinen tiedosto 
